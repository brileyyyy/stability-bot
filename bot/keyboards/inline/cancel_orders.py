...
def cancel_orders_buttons(acc_name: str) -> InlineKeyboardMarkup:
	...
	yes = InlineKeyboardButton("Yes, cancel the orders", callback_data=acc_inter_cancel_cb_data.new(
		acc_name=acc_name, id="yes"
	))
	no = InlineKeyboardButton("No", callback_data=acc_inter_cancel_cb_data.new(
